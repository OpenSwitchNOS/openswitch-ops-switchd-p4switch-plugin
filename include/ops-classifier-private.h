...
struct ops_classifier {
    ...
    int    port_ref_count;                     /* Count of ports this applied on */
};
...
#define src_ip6     entry_fields.src_ip_address.v6
#define src_mask6   entry_fields.src_ip_address_mask.v6
#define dst_ip6     entry_fields.dst_ip_address.v6
#define dst_mask6   entry_fields.dst_ip_address_mask.v6
...
struct ops_cls_rule_entry {
    struct ovs_list node;
    switch_handle_t index;  //VIVEK TODO: Change to void*
};
