...
p4_vport_create_tunnel(struct ofbundle *bundle, struct netdev *netdev)
{
    ...
    tunnel_info.u.ip_encap.src_ip.prefix_len = P4_SWITCH_API_DEFAULT_IP_PREFIX;
    ...
    tunnel_info.u.ip_encap.dst_ip.prefix_len = P4_SWITCH_API_DEFAULT_IP_PREFIX;
                              ...
                              struct ops_neighbor *nbor)
{
    ...
    neighbor1.ip_addr.prefix_len = P4_SWITCH_API_DEFAULT_IP_PREFIX;
    ...
    neighbor2.ip_addr.prefix_len = P4_SWITCH_API_DEFAULT_IP_PREFIX;
    mac_addr = ether_aton(CONST_CAST(char *, nbor->mac));
