...
int
ops_vport_bind_access_port(int hw_unit, p4_pbmp_t pbm, int vni, int vlan)
{
    ...
    P4_PBMP_ITER (pbm, aport) {
        access_handle = get_intf_handle_and_remove_vlan(aport);
...
int
ops_vport_unbind_access_port(int hw_unit, p4_pbmp_t pbm, int vni)
{
