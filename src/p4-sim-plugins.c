...
{
    int retval;
    struct plugin_extension_interface vxlan_p4_interface;

    p4_switch_init();
    VLOG_INFO("P4 Switch initialization completed");
    vxlan_p4_interface.plugin_name = VXLAN_ASIC_PLUGIN_INTERFACE_NAME;
    vxlan_p4_interface.major = VXLAN_ASIC_PLUGIN_INTERFACE_MAJOR;
    vxlan_p4_interface.minor = VXLAN_ASIC_PLUGIN_INTERFACE_MINOR;
    vxlan_p4_interface.plugin_interface = (void *)&vxlan_p4_interface;
    register_plugin_extension(&vxlan_p4_interface);
